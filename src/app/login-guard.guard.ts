...
export class LoginGuardGuard implements CanActivate, CanActivateChild, CanDeactivate<unknown>, CanLoad, CanMatch {
  canActivate(
  ...
  canDeactivate(
    ...
    nextState?: RouterStateSnapshot): Observable<boolean | UrlTree> | Promise<boolean | UrlTree> | boolean | UrlTree {
      console.log(currentState.url);
      if(currentState.url=="log" && nextState?.url=="splash"){
      return false;
    }
    else{
      return true;
